...
produtoRoutes.put('/edit/:id', authMiddleware(), ensureValidId, produtoController.edit)
produtoRoutes.delete('/delete/:id', authMiddleware(), ensureValidId, produtoController.delete)
